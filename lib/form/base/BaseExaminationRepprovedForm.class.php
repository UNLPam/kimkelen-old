...
/**
 * ExaminationRepproved form base class.
 *
 * @package    symfony
 * @subpackage form
 * @author     Your name here
 */
class BaseExaminationRepprovedForm extends BaseFormPropel
{
