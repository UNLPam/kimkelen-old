...
class PersonForm extends BasePersonForm
{
  public function configure()
  {
    ...
    //nuevo civil_status
    /*$this->setWidget('civil_status', new sfWidgetFormChoice(array(
      'choices' => BaseCustomOptionsHolder::getInstance('CivilStatus')->getOptions()
    )));
    $this->setValidator('civil_status', new sfValidatorChoice(array(
      'choices' => BaseCustomOptionsHolder::getInstance('CivilStatus')->getKeys(), 'required' => true)
    ));
    */
