...
(
	...
	`must_change_password` TINYINT default 0 NOT NULL,
	PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `sf_guard_secure_login_failure`;
...
DROP TABLE IF EXISTS `sf_guard_secure_password_policy_history`;
