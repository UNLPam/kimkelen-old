...
<div id="sf_admin_container">
  <h1><?php echo __('Ver división', array(), 'messages') ?></h1>

  <?php include_partial('division/flashes') ?>

  <?php include_partial('division/show_form_slot_actions', array('division' => $division, 'form' => $form, 'helper' => $helper)) ?>
  ...
  <div id="sf_admin_content">
    <?php include_partial('division/show_form', array('division' => $division, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>
