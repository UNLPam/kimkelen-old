 ...
 */
class BaseDivision_courseGeneratorHelper extends sfModelGeneratorHelper
{
  public function fillSlotActionDefaults(&$params)
  {
    ...
    $params['icon'] = (isset($params['icon'])) ? $params['icon'] : 'icons/16x16/generic.png';
    $params['params']['class'] = (isset($params['params']['class'])) ? $params['params']['class'] : 'button';
    $params['params']['image_class'] = (isset($params['params']['image_class'])) ? $params['params']['image_class'] : 'image';
    $params['params']['text_class'] = (isset($params['params']['text_class'])) ? $params['params']['text_class'] : 'text';
  ...
  public function getSlotActionImage($params, $default = 'icons/16x16/generic.png')
  {
  ...
  {
    return 'list' == $action ? 'division_course' : 'division_course_'.$action;
  }
