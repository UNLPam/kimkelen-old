...
<div id="sf_admin_container">
  <h1><?php echo __('Show Division course', array(), 'messages') ?></h1>

  <?php include_partial('division_course/flashes') ?>

  <?php include_partial('division_course/show_form_slot_actions', array('course' => $course, 'form' => $form, 'helper' => $helper)) ?>
  ...
  <div id="sf_admin_content">
    <?php include_partial('division_course/show_form', array('course' => $course, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>
