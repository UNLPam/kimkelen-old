...
$this->handlers['modules/*/config/view.yml'] = new ncFlavorViewConfigHandler();
...
$this->handlers['config/pm_pdf_kit.yml'] = new sfDefineEnvironmentConfigHandler(array (
  'prefix' => 'pkp_',
));
$this->handlers['config/phpexcel.yml'] = new sfDefineEnvironmentConfigHandler(array (
  'prefix' => 'ex_',
));
$this->handlers['config/nc_flavor.yml'] = new ncFlavorConfigHandler();
