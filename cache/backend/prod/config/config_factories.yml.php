...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'err',
  'file' => '/opt/lampp/htdocs/kimkelen/log/backend_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'pmI18N');
    $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/lampp/htdocs/kimkelen/cache/backend/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/lampp/htdocs/kimkelen/apps/backend/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('kimkelen-'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'kimkelen-',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/lampp/htdocs/kimkelen/cache/backend/prod/template',
  'lifetime' => 86400,
  'prefix' => '/opt/lampp/htdocs/kimkelen/apps/backend/template',
)));
